    ...
    public themes = [
        {
            ...
            props:[
                ...
                { name:'--feedback-title-size'             ,value:'30px'},
        ...
        },        
        {
            ...
            props:[
                ...
                { name:'--footer-link-size'                ,value:'14px'},
                { name:'--footer-title-size'               ,value:'16px'},
                { name:this.PROP_KFW_LOGO                  ,value:'kfw_blue.png'},
                { name:'--feedback-title-size'             ,value:'20px'},
                ...
                { name:'--feedback-ticker'                 ,value:'-500%'},                
                { name:'--feedback-time'                   ,value:'8s'},
        ...
        },        
        {
            ...
            props:[
                ...
                { name:'--feedback-ticker-st'              ,value:'100%'},  
                { name:'--feedback-ticker-en'              ,value:'-600%'},                
                { name:'--feedback-time'                   ,value:'8s'},
                { name:'--gmap-height'                     ,value:'400px'},
                { name:'--gmap-width'                      ,value:'310px'},
